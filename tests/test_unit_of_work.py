    ...
    try:
        ...
        with UnitOfWork(conn, current_user="test_user") as uow:
            ...
            student = Student(
                ...
                course=2,
                form="денна",
                group_number=104,       # реально існуюча група
                university_id=3,        # університет групи
            ...
            staff_member = Staff(
                ...
                pib="Тест Персонал",
                salary=15000,
                cabinet=301,           # кабінет університету 3
                university_id=3,
                university_name="Харківський національний університет"
            )
            ...
            # --- Тест Group ---
            group = Group(999, 10, "Тест", 3, "ХНУ")  # університет 3
            ...
            # --- Тест Cabinet ---
            cabinet = Cabinet(999, 1, 30, "Лекції", 3)
