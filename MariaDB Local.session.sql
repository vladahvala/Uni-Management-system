...
CREATE TABLE Університет (
    ...
    Паспорт_директора VARCHAR(20) NOT NULL,  
    PRIMARY KEY (ID),
    CONSTRAINT FK_Університет_Директор FOREIGN KEY (Паспорт_директора)
        REFERENCES Директор(Паспорт)
        ON DELETE CASCADE
        ON UPDATE CASCADE
);
...
CREATE TABLE Кабінет (
    ...
    ID_університету INT NOT NULL,
    PRIMARY KEY (Номер),
    CONSTRAINT fk_Кабінет_Університет FOREIGN KEY (ID_університету) REFERENCES Університет(ID) ON DELETE CASCADE ON UPDATE CASCADE
);
...
VALUES
(101, 1, 40, 'Засідання', 1),
(102, 1, 30, 'Лекції', 1),
(201, 2, 35, 'Лекції', 2),
(202, 2, 50, 'Практичні заняття', 2),
(301, 3, 30, 'Лекції', 3),
(302, 3, 50, 'Практичні заняття', 3),
(203, 2, 32, 'Засідання', 1),
(204, 2, 60, 'Лекції', 1),
(303, 3, 40, 'Засідання', 2),
(304, 3, 40, 'Практичні заняття', 2),
(04, 1, 40, 'Практичні заняття', 2),
(05, 1, 40, 'Практичні заняття', 1),
(06, 1, 40, 'Практичні заняття', 3);

-- Викладачі
INSERT INTO Член_персоналу (Паспорт, Зарплата, ID_університету, Номер_кабінету) VALUES
('GG123123', 18000.00, 2, 201),
('HH234234', 19000.00, 2, 202),
('II345345', 17000.00, 3, 301),
('JJ456456', 16000.00, 3, 302);
...
-- Директори
INSERT INTO Член_персоналу (Паспорт, Зарплата, ID_університету, Номер_кабінету) VALUES
('TT112233', 25000.00, 2, 4),
('SS778899', 26000.00, 1, 5),
('ZZ334455', 27000.00, 3, 6);
...
-- Директори 
INSERT INTO Директор (Паспорт, Кабінет, Дата_призначення) VALUES
('TT112233', 4, '2023-09-01'),
('SS778899', 5, '2022-09-01'),
('ZZ334455', 6, '2024-01-15');

-- Групи
INSERT INTO Група (Номер, Кількість_студентів, Спеціальність, ID_університету, Паспорт_викладача) VALUES
(101, 10, 'Математика', 2, 'HH234234'),
(102, 12, 'Фізика', 2, 'GG123123'),
(103, 15, 'Хімія', 3, 'II345345'),
(104, 8, 'Фізика', 3, 'JJ456456'),
(105, 9, 'Біотехнології', 2, 'GG123123');

-- Університети
INSERT INTO Університет (ID, Назва, Адреса, Тип, Рік_заснування, Паспорт_директора)
VALUES
(1, 'Київський національний університет', 'м. Київ, вул. Володимирська, 60', 'державний', 1901, 'SS778899'),
(2, 'Львівський національний університет', 'м. Львів, вул. Університетська, 1', 'державний', 1929, 'TT112233'),
(3, 'Харківський національний університет', 'м. Харків, вул. Пушкінська, 10', 'державний', 1980, 'ZZ334455');
...
('2025-10-23', '09:00:00', 201, 'Математика', 90),
('2025-10-23', '11:00:00', 202, 'Фізика', 120),
('2025-10-24', '10:00:00', 301, 'Хімія', 90),
('2025-10-24', '13:00:00', 302, 'Інформатика', 60),
('2025-10-25', '09:00:00', 201, 'Математика', 90),
('2025-10-25', '11:00:00', 202, 'Фізика', 60);

-- Лекції
INSERT INTO Лекція (Дата, Час_початку, Номер_кабінету, Розглянутий_матеріал) VALUES
('2025-10-23', '09:00:00', 201, 'Тригонометричні функції'),
('2025-10-23', '11:00:00', 202, 'Закони Ньютона');

-- Практики
INSERT INTO Практика (Дата, Час_початку, Номер_кабінету, Кількість_учасників) VALUES
('2025-10-24', '10:00:00', 301, 15),
('2025-10-24', '13:00:00', 302, 12);

-- Екзамени
INSERT INTO Екзамен (Дата, Час_початку, Номер_кабінету, Кількість_перевіряючих) VALUES
('2025-10-25', '09:00:00', 201, 2);

-- Консультації
INSERT INTO Консультація (Дата, Час_початку, Номер_кабінету, Питання) VALUES
('2025-10-25', '11:00:00', 202, 'Питання по фізиці');

-- Група_Пара 
INSERT INTO Група_Пара (Номер_групи, Дата, Час_початку, Номер_кабінету) VALUES
(101, '2025-10-23', '09:00:00', 201),
(104, '2025-10-24', '13:00:00', 302),
(102, '2025-10-23', '11:00:00', 202),
(105, '2025-10-24', '10:00:00', 301),
(101, '2025-10-25', '09:00:00', 201),
(102, '2025-10-25', '11:00:00', 202);

-- Проведення_пар
INSERT INTO Проведення_пар (Паспорт_викладача, Дата, Час_початку, Номер_кабінету) VALUES
('HH234234', '2025-10-23', '09:00:00', 201),  
('GG123123', '2025-10-23', '11:00:00', 202),  
('II345345', '2025-10-24', '10:00:00', 301),  
('JJ456456', '2025-10-24', '13:00:00', 302),  
('HH234234', '2025-10-25', '09:00:00', 201),  
('GG123123', '2025-10-25', '11:00:00', 202);
...
('AA123456', '2025-10-23', '09:00:00', 201), 
('DD654321', '2025-10-23', '11:00:00', 202), 
('BB987654', '2025-10-24', '10:00:00', 301),  
('EE112233', '2025-10-24', '13:00:00', 302), 
('AA123456', '2025-10-25', '09:00:00', 201),  
('BB987654', '2025-10-25', '11:00:00', 202); 
...
BEGIN
    ...
    JOIN Студент st ON s.Паспорт = st.Паспорт
    WHERE s.Паспорт = pPassport AND st.IsDeleted = 0;
END;
...
BEGIN
    ...
    INSERT INTO Член_персоналу (Паспорт, Зарплата, ID_університету, Номер_кабінету, UpdatedBy)
    VALUES (pPassport, pSalary, pUniversityID, pCabinetNumber, pUser);
END;
...
JOIN Людина l ON s.Паспорт = l.Паспорт
LEFT JOIN Кабінет g ON s.Номер_кабінету = g.Номер  
JOIN Університет u ON s.ID_університету = u.ID
WHERE s.IsDeleted = 0;
...
CREATE PROCEDURE AddGroup(
    ...
    IN pUniversityID INT,
    IN pTeacherPassport VARCHAR(20),
    IN pUser VARCHAR(100)
)
BEGIN
    INSERT INTO Група (Номер, Кількість_студентів, Спеціальність, ID_університету, Паспорт_викладача, UpdatedBy)
    VALUES (pNumber, pStudentCount, pSpecialty, pUniversityID, pTeacherPassport, pUser);
END;
...
BEGIN
    ...
    SET Кількість_студентів = pStudentCount,
        ...
        ID_університету = pUniversityID,
        Паспорт_викладача = pTeacherPassport,
        UpdatedAt = NOW(),
        UpdatedBy = pUser
    WHERE Номер = pNumber;
END;
...
CREATE PROCEDURE GetGroupByNumber(
    IN pNum INT
)
BEGIN
...
DROP VIEW IF EXISTS GroupDetails;
...
SELECT 
    ...
    u.ID AS ID_університету,
    u.Назва AS Університет,
    v.Паспорт AS Паспорт_викладача,
    l.ПІБ AS Викладач,
    g.UpdatedAt,
    g.UpdatedBy
FROM Група g
...
BEGIN
    INSERT INTO Кабінет (Номер, Поверх, Кількість_місць, Тип, ID_університету, UpdatedBy)
    VALUES (pNumber, pFloor, pCapacity, pType, pUniversityID, pUser);
END;
...
LEFT JOIN Член_персоналу s ON c.Номер = s.Номер_кабінету AND s.IsDeleted = 0
...
SELECT 
    ...
    e.Тривалість
FROM Захід e
JOIN Кабінет c ON e.Номер_кабінету = c.Номер AND c.IsDeleted = 0
WHERE e.IsDeleted = 0;
...
SELECT 
    ...
    p.Тривалість
FROM Пара p
JOIN Кабінет c ON p.Номер_кабінету = c.Номер AND c.IsDeleted = 0
WHERE p.IsDeleted = 0;
...
CREATE OR REPLACE TRIGGER CheckCabinetAvailability
...
BEGIN
    IF EXISTS (
        ...
        WHERE Номер_кабінету = NEW.Номер_кабінету
          AND Дата = NEW.Дата
          AND NEW.Час_початку < ADDTIME(Час_початку, SEC_TO_TIME(Тривалість*60))
          AND ADDTIME(NEW.Час_початку, SEC_TO_TIME(NEW.Тривалість*60)) > Час_початку
    ) THEN
...
CREATE OR REPLACE TRIGGER CheckCabinetAvailability_event
...
BEGIN
    IF EXISTS (
        ...
        WHERE Номер_кабінету = NEW.Номер_кабінету
          AND Дата = NEW.Дата
          AND TIME_TO_SEC(NEW.Час_початку) < TIME_TO_SEC(ADDTIME(Час_початку, SEC_TO_TIME(Тривалість*60)))
          AND TIME_TO_SEC(ADDTIME(NEW.Час_початку, SEC_TO_TIME(NEW.Тривалість*60))) > TIME_TO_SEC(Час_початку)
    ) THEN
        SIGNAL SQLSTATE '45000'
        SET MESSAGE_TEXT = 'Кабінет зайнятий на цей час';
    END IF;
...
CREATE OR REPLACE TRIGGER CabinetCheck
BEFORE INSERT ON Член_персоналу
FOR EACH ROW
BEGIN
    IF NEW.Номер_кабінету IS NOT NULL THEN
        IF NOT EXISTS (
            SELECT 1
            FROM Кабінет
            WHERE Номер = NEW.Номер_кабінету
...
CREATE OR REPLACE TRIGGER CuratorCheck
BEFORE INSERT ON Група
FOR EACH ROW
BEGIN
    IF NEW.Паспорт_викладача IS NOT NULL THEN
        IF NOT EXISTS (
            SELECT 1
            FROM Член_персоналу
...
CREATE OR REPLACE TRIGGER CheckDirectorUniversity
...
BEGIN
    ...
    INTO cnt
    FROM Університет
    WHERE Паспорт_директора = NEW.Паспорт;

    IF cnt = 0 THEN
        SIGNAL SQLSTATE '45000'
        SET MESSAGE_TEXT = 'Неможливо додати директора: такий університет не існує або директор не призначений';
    END IF;
END;

-- перевіряє, що викладач, що проводить пару, належить до того ж університету
CREATE OR REPLACE TRIGGER CheckTeacherForLesson
BEFORE INSERT ON Проведення_пар
FOR EACH ROW
BEGIN
    DECLARE uni_id INT;
    DECLARE teacher_uni INT;

    -- Дізнаємося університет через кабінет, де проходить пара
    SELECT ID_університету INTO uni_id
    FROM Кабінет
    WHERE Номер = NEW.Номер_кабінету;

    -- Дізнаємося університет викладача
    SELECT ID_університету INTO teacher_uni
    FROM Член_персоналу
    WHERE Паспорт = NEW.Паспорт_викладача;

    -- Перевіряємо, чи збігаються університети
    IF uni_id IS NULL OR teacher_uni IS NULL OR uni_id <> teacher_uni THEN
        SIGNAL SQLSTATE '45000'
...
CREATE OR REPLACE TRIGGER CheckTeacherDoubleBooking
BEFORE INSERT ON Проведення_пар
FOR EACH ROW
BEGIN
    ...
    -- беремо час початку та тривалість з NEW
    SET new_start = NEW.Час_початку;

    SELECT ADDTIME(NEW.Час_початку, SEC_TO_TIME(p.Тривалість*60)) 
    INTO new_end
    FROM Пара p
    WHERE p.Дата = NEW.Дата
      AND p.Номер_кабінету = NEW.Номер_кабінету
      AND p.Час_початку = NEW.Час_початку;

    -- Якщо тривалість не знайшлась у Пара, беремо 90 хв за замовчуванням (можна змінити)
    IF new_end IS NULL THEN
        SET new_end = ADDTIME(new_start, '01:30:00'); -- 1 година 30 хв
    END IF;

    -- перевірка перетину часу з іншими парами того ж викладача
    IF EXISTS (
        SELECT 1
        ...
        WHERE pp.Паспорт_викладача = NEW.Паспорт_викладача
          AND pp.Дата = NEW.Дата
          AND NOT (ADDTIME(p.Час_початку, SEC_TO_TIME(p.Тривалість*60)) <= new_start 
                   OR p.Час_початку >= new_end)
    ) THEN
        SIGNAL SQLSTATE '45000'
...
-- Підрахунок студентів у групі 101
SELECT CountStudentsInGroup(101) AS Кількість_студентів;
...
-- Отримати список студентів 1 курсу університету з ID = 1
SELECT StudentsInCourse(1, 1) AS Студенти;
...
-- Список груп, які курує викладач з паспортом HH234234
SELECT GroupsOfTeacher('HH234234') AS Групи;
...
SELECT LessonsOfTeacher('HH234234') AS Пари;
...
SELECT EventsByTypeRange('Засідання', '2025-10-23', '2025-10-24') AS Заходи;


-- Список персоналу університету
CREATE OR REPLACE FUNCTION StaffByUniversity(uni_id INT)
RETURNS TEXT
DETERMINISTIC
BEGIN
    ...
    SELECT GROUP_CONCAT(
               CONCAT('Паспорт: ', cp.Паспорт, ', ПІБ: ', l.ПІБ)
               SEPARATOR '; '
           )
    INTO staff_list
...
SELECT StaffByUniversity(2) AS Персонал;
...
SELECT AverageSalary(2) AS Середня_зарплата;
